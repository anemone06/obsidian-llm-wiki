export const FR_TEXTS = {
    ...
    welcomeNoteSettingsToggleDesc: 'Quand activé, le plugin crée <wikiFolder>/Welcome.md au premier chargement du plugin si le dossier wiki est manquant ou vide. La note est éditable — remplis ton focus de domaine, choisis 2-3 notes sources à ingérer, et le graphe de liens s\'ensemence automatiquement. La note est auto-traduite dans ta langue wiki via le LLM (fallback anglais si LLM non configuré). Utilise la palette de commandes « Recréer la note Welcome Wiki » pour régénérer à la demande. Désactive pour ne jamais créer automatiquement.',
