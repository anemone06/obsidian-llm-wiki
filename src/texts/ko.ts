export const KO_TEXTS = {
    ...
    welcomeNoteSettingsToggleDesc: '활성화하면 플러그인 로드 시 wiki 폴더가 없거나 비어 있으면 <wikiFolder>/Welcome.md를 생성합니다. 노트는 편집 가능 — 도메인 포커스를 입력하고, 2-3개의 소스 노트를 수집하면 링크 그래프가 자동으로 시드됩니다. 노트는 LLM을 통해 wiki 언어로 자동 번역됩니다(LLM 미설정 시 영어로 폴백). 명령 팔레트의 "Wiki Welcome 노트 재생성"으로 필요에 따라 재생성할 수 있습니다. 비활성화하면 자동 생성하지 않습니다.',
