export const PT_TEXTS = {
    ...
    welcomeNoteSettingsToggleDesc: 'Quando ativado, o plugin cria <wikiFolder>/Welcome.md na primeira vez que o plugin carrega e a pasta wiki está em falta ou vazia. A nota é editável — preenche o teu foco de domínio, escolhe 2-3 notas-fonte para ingerir, e o grafo de links é semeado automaticamente. A nota é traduzida automaticamente para o teu idioma wiki via LLM (fallback para inglês se o LLM não estiver configurado). Usa o comando da paleta "Recriar nota Welcome do Wiki" para regenerar sob pedido. Desativa para nunca criar automaticamente.',
