export const DE_TEXTS = {
    ...
    welcomeNoteSettingsToggleDesc: 'Wenn aktiviert, erstellt das Plugin <wikiFolder>/Welcome.md beim Plugin-Start, wenn der Wiki-Ordner fehlt oder leer ist. Die Notiz ist editierbar — fülle deinen Domain-Fokus aus, wähle 2-3 Quellnotizen zum Ingestieren, und der Link-Graph wird automatisch gesetzt. Die Notiz wird via LLM automatisch in deine Wiki-Sprache übersetzt (Englisch-Fallback, wenn LLM nicht konfiguriert). Verwende den Befehlspalette-Befehl "Wiki-Willkommen-Notiz neu erstellen", um bei Bedarf neu zu generieren. Deaktivieren, um Auto-Erstellung zu verhindern.',
